...
DESCRIBE_QUEUE_SERVICES = [
    {
        "id": f"{sa1}/queueServices/QS1",
        "name": "QS1",
        "type": "Microsoft.Storage/storageAccounts/queueServices",
        "storage_account_id": sa1,
    },
    {
        "id": f"{sa2}/queueServices/QS2",
        "name": "QS2",
        "type": "Microsoft.Storage/storageAccounts/queueServices",
...
DESCRIBE_TABLE_SERVICES = [
    {
        "id": f"{sa1}/tableServices/TS1",
        "name": "TS1",
        "type": "Microsoft.Storage/storageAccounts/tableServices",
        "storage_account_id": sa1,
    },
    {
        "id": f"{sa2}/tableServices/TS2",
        "name": "TS2",
        "type": "Microsoft.Storage/storageAccounts/tableServices",
        "storage_account_id": sa2,
    },
...
DESCRIBE_FILE_SERVICES = [
    {
        "id": f"{sa1}/fileServices/FS1",
        "name": "FS1",
        "type": "Microsoft.Storage/storageAccounts/fileServices",
        "storage_account_id": sa1,
    },
    {
        "id": f"{sa2}/fileServices/FS2",
        "name": "FS2",
        "type": "Microsoft.Storage/storageAccounts/fileServices",
        "storage_account_id": sa2,
    },
...
DESCRIBE_BLOB_SERVICES = [
    {
        "id": f"{sa1}/blobServices/BS1",
        "name": "BS1",
        "type": "Microsoft.Storage/storageAccounts/blobServices",
        "storage_account_id": sa1,
    },
    {
        "id": f"{sa2}/blobServices/BS2",
        "name": "BS2",
        "type": "Microsoft.Storage/storageAccounts/blobServices",
        "storage_account_id": sa2,
    },
...
DESCRIBE_QUEUE = [
    {
        "id": f"{sa1}/queueServices/QS1/queues/queue1",
        "name": "queue1",
        "type": "Microsoft.Storage/storageAccounts/queueServices/queues",
        "service_id": f"{sa1}/queueServices/QS1",
    },
    {
        "id": f"{sa2}/queueServices/QS2/queues/queue2",
        "name": "queue2",
        "type": "Microsoft.Storage/storageAccounts/queueServices/queues",
        "service_id": f"{sa2}/queueServices/QS2",
    },
]
...
DESCRIBE_TABLES = [
    {
        "id": f"{sa1}/tableServices/TS1/tables/table1",
        "name": "table1",
        "type": "Microsoft.Storage/storageAccounts/tableServices/tables",
        "service_id": f"{sa1}/tableServices/TS1",
    },
    {
        "id": f"{sa2}/tableServices/TS2/tables/table2",
        "name": "table2",
        "type": "Microsoft.Storage/storageAccounts/tableServices/tables",
        "service_id": f"{sa2}/tableServices/TS2",
    },
]
...
DESCRIBE_FILE_SHARES = [
    {
        "id": f"{sa1}/fileServices/FS1/shares/share1",
        "name": "share1",
        ...
        "service_id": f"{sa1}/fileServices/FS1",
    },
    {
        "id": f"{sa2}/fileServices/FS2/shares/share2",
        "name": "share2",
        "type": "Microsoft.Storage/storageAccounts/fileServices/shares",
        "etag": "\"0x8D589847D51C7DE\"",
        "last_modified_time": "2019-05-14T08:20:47Z",
        ...
        "version": "1234567890",
        "remaining_retention_days": 30,
        "service_id": f"{sa2}/fileServices/FS2",
    },
]
...
DESCRIBE_BLOB_CONTAINERS = [
    {
        "id": f"{sa1}/blobServices/BS1/containers/container1",
        "name": "container1",
        ...
        "service_id": f"{sa1}/blobServices/BS1",
    },
    {
        "id": f"{sa2}/blobServices/BS2/containers/container2",
        "name": "container2",
        "type": "Microsoft.Storage/storageAccounts/blobServices/containers",
        "etag": "\"0x8D589847D51C7DE\"",
        "public_access": "Container",
        ...
        "has_immutability_policy": False,
        "has_legal_hold": False,
        "service_id": f"{sa2}/blobServices/BS2",
    },
]
